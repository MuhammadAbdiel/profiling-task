...
<div class="card mb-3">
  ...
  <div class="text-center" style="max-height: 350px; overflow: hidden;">
    <img src="{{ asset('storage/post-images/' . explode('/', $posts[0]->image)[2]) }}"
  ...
  <div class="card-body text-center">
    ...
    <p>
      <small class="text-muted">
        By. <a class="text-decoration-none" href="/posts?author={{ $posts[0]->author->username }}">{{
  ...
  <div class="row">
    ...
    <div class="col-md-4 mb-3">
      <div class="card">
        ...
        @if ($post->image)
        <img src="{{ asset('storage/post-images/' . explode('/', $post->image)[2]) }}" alt="{{ $post->category->name }}"
          class="img-fluid">
        @else
        ...
        <div class="card-body">
          ...
          <p>
            <small class="text-muted">
              By. <a class="text-decoration-none" href="/posts?author={{ $post->author->username }}">{{
                $post->author->name }}</a>
              in
